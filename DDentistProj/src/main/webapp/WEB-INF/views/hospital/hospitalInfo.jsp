...
// 					var resultList =  JSON.stringify(result);
					...
					// {"chairSn":39,"chairNm":"4번 체어","deptCd":"1"}
					  ...
					  td_chName.setAttribute("class", "form-control updateInput")
...
<%-- 												<td>${chair.chairSn}</td> --%>
												...
												<td>
													<input type="text" data-chair="${chair.chairNm}" class="form-control updateInput"
								...
								<template id="rowTemplate">
									<tr class="trClassAdd">
										<td><input type="checkbox" class="form-control"  name="user_Check" id="checkYn" required checked></td>
										<td></td>
										<td><input type="text" class="form-control updateInput" id="chairNm"/></td>
										<td><select id="deptCd" name="deptCd" class="form-control" >
												<option value="">진료실 선택</option>
												<c:forEach var="dept" items="${requestScope.deptList}">
													<option value="${dept.deptCd}"
								...
								<template id="readOnlyTemplate">
									<tr class="trClassAdd">
										<td><input type="checkbox" class="form-control" name="user_Check" id="checkYn"></td>
										<td></td>
										<td><input type="text" class="form-control updateInput" id="chairNm" style="border:none;" readOnly/></td>
										<td><select id="deptCd" name="deptCd" class="form-control" disabled>
												<option value="">진료실 선택</option>
												<c:forEach var="dept" items="${requestScope.deptList}">
