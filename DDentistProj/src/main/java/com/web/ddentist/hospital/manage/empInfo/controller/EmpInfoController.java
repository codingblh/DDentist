...
public class EmpInfoController {
	...
	public int createPost(@ModelAttribute EmployeeVO employeeVO,
	...
	public String fileUpload(MultipartFile uploadFile) {
		...
		String uploadFolder = System.getProperty("user.dir").replace("\\eclipse", "")
							 + "\\workspace\\DDentistProj\\src\\main\\webapp\\resources\\images\\employee";
